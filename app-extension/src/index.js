...
function extendConf (conf, api) {
  ...
  if (api.hasWebpack) {
    ...
    transpileTarget.push(/quasar-app-extension-amber[\\/]src/)
  }

  // make sure the stylesheet goes through webpack to avoid SSR issues
  conf.css.push('~quasar-ui-amber/src/index.sass')
}
...
export default function (api) {
  ...
  // api.registerDescribeApi('QASection', '~quasar-ui-amber/src/components/QASection.json')
